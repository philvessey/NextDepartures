...
public partial class Feed
{
    ...
    public async Task<List<Agency>> GetAgenciesByNameAsync(
        string name = null,
        ...
        try
        {
            var agenciesFromStorage = await _dataStorage.GetAgenciesByNameAsync(
                name: name,
        ...
        catch (Exception e)
        {
            throw new AgencyException(
                message: "An error occurred while getting agencies by name.",
                innerException: e);
        }
    }
}