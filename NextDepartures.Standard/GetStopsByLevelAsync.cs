...
public partial class Feed
{
    ...
    public async Task<List<Stop>> GetStopsByLevelAsync(string id = "", ComparisonType comparison = ComparisonType.Partial, int results = int.MaxValue)
    {
        try
        {
            var stopsFromStorage = await _dataStorage.GetStopsByLevelAsync(id, comparison);
