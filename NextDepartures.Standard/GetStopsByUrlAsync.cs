...
public partial class Feed
{
    ...
    public async Task<List<Stop>> GetStopsByUrlAsync(
        string url = null,
        ...
        try
        {
            var stopsFromStorage = await _dataStorage.GetStopsByUrlAsync(
                url: url,
        ...
        catch (Exception e)
        {
            throw new StopException(
                message: "An error occurred while retrieving stops by url.",
                innerException: e);
        }
    }
}