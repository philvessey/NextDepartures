...
public partial class Feed
{
    ...
    public async Task<List<Stop>> GetStopsByTimezoneAsync(
        ...
        try
        {
            var stopsFromStorage = await _dataStorage.GetStopsByTimezoneAsync(
                timezone: timezone,
        ...
        catch (Exception e)
        {
            throw new StopException(
                message: "An error occurred while retrieving stops by timezone.",
                innerException: e);
        }
    }
}