...
public partial class Feed
{
    ...
    public async Task<List<Stop>> GetStopsByWheelchairBoardingAsync(WheelchairAccessibilityType wheelchairBoarding = WheelchairAccessibilityType.NoInformation, ComparisonType comparison = ComparisonType.Partial, int results = 0)
    {
        try
        {
