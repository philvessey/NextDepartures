...
public partial class Feed
{
    ...
    /// </summary>
    /// <param name="wheelchairBoarding">The wheelchair boarding status of the stop. Default is all.</param>
    ...
    public async Task<List<Stop>> GetStopsByWheelchairBoardingAsync(string wheelchairBoarding = "", ComparisonType comparison = ComparisonType.Partial, int results = int.MaxValue)
    {
        try
        {
