...
public partial class Feed
{
    ...
    public async Task<List<Agency>> GetAgenciesByPhoneAsync(
        string phone = null,
        ...
        try
        {
            var agenciesFromStorage = await _dataStorage.GetAgenciesByPhoneAsync(
                phone: phone,
        ...
        catch (Exception e)
        {
            throw new AgencyException(
                message: "An error occurred while getting agencies by phone number.",
                innerException: e);
        }
    }
}