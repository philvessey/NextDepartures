...
public partial class Feed
{
    ...
    public async Task<List<Stop>> GetStopsByIdAsync(
        string id = null,
        ...
        try
        {
            var stopsFromStorage = await _dataStorage.GetStopsByIdAsync(
                id: id,
        ...
        catch (Exception e)
        {
            throw new StopException(
                message: "An error occurred while retrieving stops by id.",
                innerException: e);
        }
    }
}