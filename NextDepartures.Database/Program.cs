...
foreach (var a in feed.Agencies)
{
    ...
    command.Parameters.AddWithValue(
        ...
        value: a.Id is not null ? a.Id.TrimDoubleQuotes() : DBNull.Value);
    ...
    command.Parameters.AddWithValue(
        ...
        value: a.LanguageCode is not null ? a.LanguageCode.TrimDoubleQuotes() : DBNull.Value);
    
    command.Parameters.AddWithValue(
        parameterName: "@agencyPhone",
        value: a.Phone is not null ? a.Phone.TrimDoubleQuotes() : DBNull.Value);
    
    command.Parameters.AddWithValue(
        parameterName: "@agencyFareUrl",
        value: a.FareURL is not null ? a.FareURL.TrimDoubleQuotes() : DBNull.Value);
    
    command.Parameters.AddWithValue(
        parameterName: "@agencyEmail",
        value: a.Email is not null ? a.Email.TrimDoubleQuotes() : DBNull.Value);
...
foreach (var f in feed.FareAttributes)
{
    ...
    command.Parameters.AddWithValue(
        parameterName: "@agencyId",
        value: f.AgencyId is not null ? f.AgencyId.TrimDoubleQuotes() : DBNull.Value);
    
    command.Parameters.AddWithValue(
        parameterName: "@transferDuration",
        value: f.TransferDuration is not null ? f.TransferDuration.TrimDoubleQuotes() : DBNull.Value);
...
foreach (var f in feed.FareRules)
{
    ...
    command.Parameters.AddWithValue(
        ...
        value: f.RouteId is not null ? f.RouteId.TrimDoubleQuotes() : DBNull.Value);
    
    command.Parameters.AddWithValue(
        parameterName: "@originId",
        value: f.OriginId is not null ? f.OriginId.TrimDoubleQuotes() : DBNull.Value);
    
    command.Parameters.AddWithValue(
        parameterName: "@destinationId",
        value: f.DestinationId is not null ? f.DestinationId.TrimDoubleQuotes() : DBNull.Value);
    
    command.Parameters.AddWithValue(
        parameterName: "@containsId",
        value: f.ContainsId is not null ? f.ContainsId.TrimDoubleQuotes() : DBNull.Value);
...
foreach (var f in feed.Frequencies)
{
    ...
    command.Parameters.AddWithValue(
        ...
        value: f.ExactTimes is not null ? f.ExactTimes.ToString() != string.Empty ? f.ExactTimes : string.Empty : DBNull.Value);
...
foreach (var l in feed.Levels)
{
    ...
    command.Parameters.AddWithValue(
        ...
        value: l.Name is not null ? l.Name.TrimDoubleQuotes() : DBNull.Value);
...
foreach (var p in feed.Pathways)
{
    ...
    command.Parameters.AddWithValue(
        ...
        value: p.Length is not null ? p.Length : DBNull.Value);
    
    command.Parameters.AddWithValue(
        parameterName: "@traversalTime",
        value: p.TraversalTime is not null ? p.TraversalTime : DBNull.Value);
    
    command.Parameters.AddWithValue(
        parameterName: "@stairCount",
        value: p.StairCount is not null ? p.StairCount : DBNull.Value);
    
    command.Parameters.AddWithValue(
        parameterName: "@maxSlope",
        value: p.MaxSlope is not null ? p.MaxSlope.ToString() != string.Empty ? p.MaxSlope : string.Empty : DBNull.Value);
    
    command.Parameters.AddWithValue(
        parameterName: "@minWidth",
        value: p.MinWidth is not null ? p.MinWidth : DBNull.Value);
    
    command.Parameters.AddWithValue(
        parameterName: "@signpostedAs",
        value: p.SignpostedAs is not null ? p.SignpostedAs.TrimDoubleQuotes() : DBNull.Value);
    
    command.Parameters.AddWithValue(
        parameterName: "@reversedSignpostedAs",
        value: p.ReversedSignpostedAs is not null ? p.ReversedSignpostedAs.TrimDoubleQuotes() : DBNull.Value);
...
foreach (var r in feed.Routes)
{
    ...
    command.Parameters.AddWithValue(
        parameterName: "@agencyId",
        value: r.AgencyId is not null ? r.AgencyId.TrimDoubleQuotes() : DBNull.Value);
    
    command.Parameters.AddWithValue(
        parameterName: "@routeShortName",
        value: r.ShortName is not null ? r.ShortName.TrimDoubleQuotes() : DBNull.Value);
    
    command.Parameters.AddWithValue(
        parameterName: "@routeLongName",
        value: r.LongName is not null ? r.LongName.TrimDoubleQuotes() : DBNull.Value);
    
    command.Parameters.AddWithValue(
        parameterName: "@routeDesc",
        value: r.Description is not null ? r.Description.TrimDoubleQuotes() : DBNull.Value);
    ...
    command.Parameters.AddWithValue(
        ...
        value: r.Url is not null ? r.Url.TrimDoubleQuotes() : DBNull.Value);
    
    command.Parameters.AddWithValue(
        parameterName: "@routeColor",
        value: r.Color is not null ? r.Color.ToString() != string.Empty ? r.Color : string.Empty : DBNull.Value);
    
    command.Parameters.AddWithValue(
        parameterName: "@routeTextColor",
        value: r.TextColor is not null ? r.TextColor.ToString() != string.Empty ? r.TextColor : string.Empty : DBNull.Value);
...
foreach (var s in feed.Shapes)
{
    ...
    command.Parameters.AddWithValue(
        ...
        value: s.DistanceTravelled is not null ? s.DistanceTravelled : DBNull.Value);
...
foreach (var s in feed.Stops)
{
    ...
    command.Parameters.AddWithValue(
        ...
        value: s.Code is not null ? s.Code.TrimDoubleQuotes() : DBNull.Value);
    
    command.Parameters.AddWithValue(
        parameterName: "@stopName",
        value: s.Name is not null ? s.Name.TrimDoubleQuotes() : DBNull.Value);
    
    command.Parameters.AddWithValue(
        parameterName: "@stopDesc",
        value: s.Description is not null ? s.Description.TrimDoubleQuotes() : DBNull.Value);
    ...
    command.Parameters.AddWithValue(
        ...
        value: s.Zone is not null ? s.Zone.TrimDoubleQuotes() : DBNull.Value);
    
    command.Parameters.AddWithValue(
        parameterName: "@stopUrl",
        value: s.Url is not null ? s.Url.TrimDoubleQuotes() : DBNull.Value);
    
    command.Parameters.AddWithValue(
        parameterName: "@locationType",
        value: s.LocationType is not null ? s.LocationType.ToString() != string.Empty ? s.LocationType : string.Empty : DBNull.Value);
    
    command.Parameters.AddWithValue(
        parameterName: "@parentStation",
        value: s.ParentStation is not null ? s.ParentStation.TrimDoubleQuotes() : DBNull.Value);
    
    command.Parameters.AddWithValue(
        parameterName: "@stopTimezone",
        value: s.Timezone is not null ? s.Timezone.TrimDoubleQuotes() : DBNull.Value);
    
    command.Parameters.AddWithValue(
        parameterName: "@wheelchairBoarding",
        value: s.WheelchairBoarding is not null ? s.WheelchairBoarding.TrimDoubleQuotes() : DBNull.Value);
    
    command.Parameters.AddWithValue(
        parameterName: "@levelId",
        value: s.LevelId is not null ? s.LevelId.TrimDoubleQuotes() : DBNull.Value);
    
    command.Parameters.AddWithValue(
        parameterName: "@platformCode",
        value: s.PlatformCode is not null ? s.PlatformCode.TrimDoubleQuotes() : DBNull.Value);
...
foreach (var s in feed.StopTimes)
{
    ...
    command.Parameters.AddWithValue(
        ...
        value: s.ArrivalTime is not null ? s.ArrivalTime.ToString() : DBNull.Value);
    
    command.Parameters.AddWithValue(
        parameterName: "@departureTime",
        value: s.DepartureTime is not null ? s.DepartureTime.ToString() : DBNull.Value);
    
    command.Parameters.AddWithValue(
        parameterName: "@stopId",
        value: s.StopId is not null ? s.StopId.TrimDoubleQuotes() : DBNull.Value);
    ...
    command.Parameters.AddWithValue(
        ...
        value: s.StopHeadsign is not null ? s.StopHeadsign.TrimDoubleQuotes() : DBNull.Value);
    
    command.Parameters.AddWithValue(
        parameterName: "@pickupType",
        value: s.PickupType is not null ? s.PickupType.ToString() != string.Empty ? s.PickupType : string.Empty : DBNull.Value);
    
    command.Parameters.AddWithValue(
        parameterName: "@dropOffType",
        value: s.DropOffType is not null ? s.DropOffType.ToString() != string.Empty ? s.DropOffType : string.Empty : DBNull.Value);
    
    command.Parameters.AddWithValue(
        parameterName: "@shapeDistTravelled",
        value: s.ShapeDistTravelled is not null ? s.ShapeDistTravelled : DBNull.Value);
...
foreach (var t in feed.Transfers)
{
    ...
    command.Parameters.AddWithValue(
        parameterName: "@fromStopId",
        value: t.FromStopId is not null ? t.FromStopId.TrimDoubleQuotes() : DBNull.Value);
    
    command.Parameters.AddWithValue(
        parameterName: "@toStopId",
        value: t.ToStopId is not null ? t.ToStopId.TrimDoubleQuotes() : DBNull.Value);
    ...
    command.Parameters.AddWithValue(
        ...
        value: t.MinimumTransferTime is not null ? t.MinimumTransferTime : DBNull.Value);
...
foreach (var t in feed.Trips)
{
    ...
    command.Parameters.AddWithValue(
        ...
        value: t.Headsign is not null ? t.Headsign.TrimDoubleQuotes() : DBNull.Value);
    
    command.Parameters.AddWithValue(
        parameterName: "@tripShortName",
        value: t.ShortName is not null ? t.ShortName.TrimDoubleQuotes() : DBNull.Value);
    
    command.Parameters.AddWithValue(
        parameterName: "@directionId",
        value: t.Direction is not null ? t.Direction : DBNull.Value);
    
    command.Parameters.AddWithValue(
        parameterName: "@blockId",
        value: t.BlockId is not null ? t.BlockId.TrimDoubleQuotes() : DBNull.Value);
    
    command.Parameters.AddWithValue(
        parameterName: "@shapeId",
        value: t.ShapeId is not null ? t.ShapeId.TrimDoubleQuotes() : DBNull.Value);
    
    command.Parameters.AddWithValue(
        parameterName: "@wheelchairAccessible",
        value: t.AccessibilityType is not null ? t.AccessibilityType.ToString() != string.Empty ? t.AccessibilityType : string.Empty : DBNull.Value);
