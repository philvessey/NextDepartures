...
[![NuGet Version](https://img.shields.io/nuget/v/NextDepartures.Storage.SqlServer.Aspire.svg?style=flat)](https://www.nuget.org/packages/NextDepartures.Storage.SqlServer.Aspire/)
...
var feed = await Feed.LoadAsync(SqlServerStorage.Load());
```